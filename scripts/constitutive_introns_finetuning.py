...
from src.datasets.lit import ConstitutiveIntronsDataModule
from src.model.constitutive_introns import ConstitutiveIntronsClassifier
...
def parse_arguments():
    ...
    parser.add_argument("--classification_head_embedding_dimension", type=int, default=512, help="Number of workers for data loading.")
...
def main():
    ...
    # Load data module
    data_module = ConstitutiveIntronsDataModule(
    ...
    print(f"Use checkpoint flag={args.use_checkpoint}")

    # Load model
    classifier = ConstitutiveIntronsClassifier(
    ...
    trainer.test(classifier, data_module.test_dataloader())

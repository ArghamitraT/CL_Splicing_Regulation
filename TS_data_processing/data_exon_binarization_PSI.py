...
# OUT_LONG = f"{root_path}/data/TS_data/tabula_sapiens/final_data/{division}_cassette_exons_class3_by_tissue_LONG.csv"
OUT_SUMM = f"{root_path}/data/TS_data/tabula_sapiens/final_data/{division}_cassette_exons_class3_counts_by_tissue.csv"

"""
This files is used to submit files in the slurm and extract reference sequence for all species in multiz100 way
"""
import os
import time
import random
...
def create_prg_file_refseq(prg_file_path, refseq_dir, url):
...
def create_slurm_file(prg_file_path, job_name, slurm_file_path):
    ...
    "#SBATCH --time=3:45:00              #Set the wall clock limit to 1hr and 30min, # takes 100min/EM iteration **CHANGE (AT)**\n" + \
    "#SBATCH --mem=10G              \n" + \
...
code_dir = "/gpfs/commons/home/atalukder/Contrastive_Learning/code/AT_code"
...
EM_round_arr = [100] 
experiment_num = 4
input_csv = '/gpfs/commons/home/atalukder/Contrastive_Learning/data/multiz100way/species_refSeq_urls.csv'  # Replace with your CSV file path
refseq_dir = "/gpfs/commons/home/atalukder/Contrastive_Learning/data/multiz100way/refseq"
...
def download_refseq():
    with open(input_csv, 'r') as csvfile:
        ...
        # Loop through each row and print the URL column
        for row in reader:
            # Assuming the URL is the second column (index 1)
            url = row[1]
            kind ='refseq'
            ...
            create_prg_file_refseq(prg_file_path, refseq_dir, url)

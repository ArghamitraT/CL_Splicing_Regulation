"""
Searches for a given gene and saves the amino acid sequences of all other species in the 
...
alignment_file = "hg38_knownGene.exonAA.fa"
# alignment_file = "test_truncated.fa"
input_file = "/gpfs/commons/home/nkeung/data/" + alignment_file

full_name = f'/gpfs/commons/home/nkeung/cl_splicing/esm/processed_data/hg38_all_exons'
...
with open(input_file, "r") as file:
    for line in file:
        ...
        if found_species and match:
            ...
            # Add to data
            data.append((gene_name, species_name, exon_num, length_aa, start_phase, end_phase, chromosome, start_coord, 
                        end_coord, strand, aa_sequence))
            
            saved_species.add(species_name)

df = pd.DataFrame(data, columns = [
     'Gene', 'Species', 'Number', 'AA Len', 'Start Phase', 'End Phase', 'Chromosome', 'Start Coord', 

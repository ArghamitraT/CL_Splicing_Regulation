...
gene_annotation_folder = '/gpfs/commons/home/atalukder/Contrastive_Learning/data/multiz100way/gene_annotation/hg38_csv'
...
ax.set_title('Exon Match Percentage (human, ncbirefseq)')
ax.legend()

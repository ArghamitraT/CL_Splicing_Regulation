...
def create_prg_file_intronSeq(python_file_path, prg_file_path, IntronExonPosFile):
    ...
    f"python {python_file_path} --IntronExonPosFile {IntronExonPosFile}"
...
other_script_names = []
name_arr = ['get_intron_seq.py']
IntronExonPosFile_mainPath = '/gpfs/commons/home/atalukder/Contrastive_Learning/data/multiz100way/alignment/alignmentknownGene.multiz100way.exonNuc_exon_intron_positions_'
IntronExonPosFile_arr = ['split_file_1.csv', 'split_file_2.csv', 'split_file_3.csv', 'split_file_4.csv']

output_file_name = "output_IntronSeq_token_"
...
def create_readme():
    ...
    comment = f"getting intron sequences"
...
def gen_combination():
    ...
    for name in name_arr:
        for IntronExonPosFile in IntronExonPosFile_arr:
            ...
            IntronExonPosFile = IntronExonPosFile_mainPath+IntronExonPosFile
            create_prg_file_intronSeq(python_file_path, prg_file_path, IntronExonPosFile)

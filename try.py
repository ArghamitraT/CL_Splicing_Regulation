...
# pickle_file_path = '/gpfs/commons/home/atalukder/Contrastive_Learning/data/initial_data/intron_no_dash/alignmentknownGene.multiz100way.exonNuc_exon_intron_positions_split_file_1_IntronSeq.pkl'
# with open(pickle_file_path, 'rb') as f:

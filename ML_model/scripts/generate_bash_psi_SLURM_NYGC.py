...
slurm_file_name = 'Psi_mtsplice10aug'
gpu_num = 1
hour = 5
memory = 50 # GB
...
readme_comment = "psi, mtsplice warm started, intron exon, 10 aug serial run"
wandb_logger_NOTES="psi mtsplice warm started intron exon ten aug serial run"

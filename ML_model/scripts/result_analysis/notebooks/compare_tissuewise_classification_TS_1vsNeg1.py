...
top_ct = (
    merged.sort_values("delta_auprc_1_vs_-1", ascending=False)
...
top20 = merged.sort_values("delta_auprc_1_vs_-1", ascending=False).head(20)
sns.barplot(
    data=top20,
    y="tissue",
    x="delta_auprc_1_vs_-1",
    hue="Category",
    dodge=False,
    palette="tab10"
)
...
system_summary = (
    merged.groupby("System")[["delta_auroc_1_vs_-1", "delta_auprc_1_vs_-1"]]
    .mean()
    .sort_values("delta_auprc_1_vs_-1", ascending=False)
)

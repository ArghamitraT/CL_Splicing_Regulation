...
#(AT)
# valid_exons = transcript_to_exon['exon_name'].unique()[:len(exon_proportions)]      
...
# Save output
output_file = '/gpfs/commons/home/atalukder/Contrastive_Learning/models/gene_exp_psi/output/'+f'types_{tissues[tissue_index]}.pkl'

"""
Takes the gtf file from ENsemvle annotation and produces a csv file parsing the gtf
"""

import pandas as pd

# Load the GTF file, filtering out comment lines
ensemble_annotation_folder = '/gpfs/commons/home/atalukder/Contrastive_Learning/data/multiz100way/Ensembl_geneAnnotaion/homo_sapiens/'
gtf_file_path = ensemble_annotation_folder+'Homo_sapiens.GRCh38.113.gtf'
...
gtf_df['species_name'] = 'panTro4'  # Assuming species is hg38 as shown in the image
...
output_path = gtf_file_path+'_exon_data.csv'

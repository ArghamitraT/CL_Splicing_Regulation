...
OUT_HIGH = f"{root_path}/data/ASCOT/{division}_cassette_exons_with_binary_labels_HIGH_TissueBinPsi.csv"
OUT_LOW  = f"{root_path}/data/ASCOT/{division}_cassette_exons_with_binary_labels_LOW_TissueBinPsi.csv"
